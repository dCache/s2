...
setenv PATH "/home/tests/lcg/bin:/home/tests/s2/bin:$GLOBUS_LOCATION/bin:/usr/local/bin:$PATH"
setenv X509_CERT_DIR /afs/cern.ch/project/gd/LCG-share/certificates
setenv S2_MULTI_SITE yes
setenv LD_LIBRARY_PATH "/home/tests/lcg/lib:/home/tests/globus"
rehash
#
...
if ( $# <= 0 ) then
 ...
 echo "Possible options are: avail,basic,usecase,cross,bdii and lcg-utils" 
 exit 1
endif
#
set typ = "$1"
...
switch ( "${typ}" )
  ...
  case "bdii":
     ...
     breaksw
  case "lcg-utils":
     set rootdir = "${srm_root}/2.2/lcg-utils"
     set sleeptim = "1m"
     breaksw
  default:
...
if ( "x${typ}" == "xcross" ) then
  set list = "22CASTORCERN 22DCACHEDESY 22DCACHESTRESS 22DPMCERN 22STORM"
else
  set list = "22CASTORCERN 22CASTORSTRESS 22CASTORCNAF 22CASTORRAL 22DCACHEDESY 22DCACHESTRESS 22DCACHEFZK 22DCACHEEDINBURG 22DCACHEIN2P3 22DCACHEBNL2 22DCACHENDGF 22DCACHESARA 22DCACHEUCSD 22DPMCERN 22DPMGLASGOW 22DPMEDINBURG 22DPMLAL 22DRMLBNL 22STORM 22STORM1 22STORMBRISTOL 22STORMIFIC"
endif
if ( "x${typ}" == "xavail" || "x${typ}" == "xbasic" ) then
#  set list = "22CASTORCERN 22CASTORSTRESS 22CASTORCNAF 22CASTORRAL 22DCACHEDESY 22DCACHESTRESS 22DCACHEFZK 22DCACHEEDINBURG 22DCACHEIN2P3 22DCACHEBNL2 22DCACHENDGF 22DCACHESARA 22DCACHEUCSD 22DPMCERN 22DPMGLASGOW 22DPMEDINBURG 22DPMLAL 22DRMLBNL 22STORM 22STORM1 22STORMBRISTOL 22STORMIFIC"
  set list = "22CASTORCERN 22CASTORCNAF 22CASTORRAL 22DCACHEDESY 22DCACHESTRESS 22DCACHEFZK 22DCACHEEDINBURG 22DCACHEIN2P3 22DCACHEBNL2 22DCACHENDGF 22DCACHESARA 22DCACHEUCSD 22DPMCERN 22DPMLAL 22STORM1 22DRMLBNL"
endif
...
if ( "x${typ}" == "xbdii" ) then
#  set list = "22CASTORCERN 22CASTORSTRESS 22CASTORCNAF 22CASTORRAL 22DCACHEDESY 22DCACHESTRESS 22DCACHEFZK 22DCACHEEDINBURG 22DCACHEIN2P3 22DCACHEBNL2 22DCACHENDGF 22DCACHESARA 22DCACHEUCSD 22DPMCERN 22DPMGLASGOW 22DPMEDINBURG 22DPMLAL 22DRMLBNL 22STORM 22STORM1 22STORMBRISTOL 22STORMIFIC"
  set list = "22CASTORCERN 22CASTORCNAF 22DCACHEFZK 22DCACHEIN2P3 22DCACHEBNL2 22DCACHENDGF 22DCACHESARA 22DPMLAL 22STORM1"
endif
#
if ( "x${typ}" == "xlcg-utils" ) then
#  set list = "22CASTORCERN 22CASTORSTRESS 22CASTORCNAF 22CASTORRAL 22DCACHEDESY 22DCACHESTRESS 22DCACHEFZK 22DCACHEEDINBURG 22DCACHEIN2P3 22DCACHEBNL2 22DCACHENDGF 22DCACHESARA 22DCACHEUCSD 22DPMCERN 22DPMGLASGOW 22DPMEDINBURG 22DPMLAL 22DRMLBNL 22STORM 22STORM1 22STORMBRISTOL 22STORMIFIC"
  set list = "22CASTORCERN 22CASTORALICE 22CASTORATLAS 22CASTORCMS 22CASTORLHCB 22CASTORDTEAM 22CASTORCNAF 22CASTORRAL 22CASTORASGC 22DCACHEFZKPR 22DCACHEIN2P3PR 22DCACHENDGFPR 22DCACHEBNLPR 22DCACHESARAPR 22DCACHETRIUMFPR 22DPMCERN 22DPMLAL 22DPMNIKHEF 22STORM1"
endif
#
set f_logs = ""
