...
#
#set list = "22CASTORCERN 22CASTORDEV 22CASTORRAL 22DCACHEFNAL 22DCACHEDESY 22DCACHEBNL 22DPMCERN 22DPMEDINBURG 22DPMGLASGOW 22DPMLAL 22DRMLBNL 22SRMVU 22STORM 22STORM1 22STORMBRISTOL"
if ( "x${typ}" == "xcross" ) then
  set list = "22CASTORCERN 22DCACHEDESY 22DCACHESTRESS 22DPMCERN 22DRMLBNL 22STORM"
else
  set list = "22CASTORCERN 22DCACHEDESY 22DCACHESTRESS 22DCACHEBNL 22DPMCERN 22DPMGLASGOW 22DPMEDINBURG 22DPMLAL 22DRMLBNL 22STORM 22STORM1 22STORMBRISTOL"
endif
#
set f_logs = ""
