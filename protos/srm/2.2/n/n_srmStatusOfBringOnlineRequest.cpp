...
srmStatusOfBringOnlineRequest::exec(Process *proc)
{
  ...
  std::vector <std::string *> SURL = proc->eval_vec_str(srmStatusOfBringOnlineRequest::SURL);
...
srmStatusOfBringOnlineRequest::toString(Process *proc)
{
  ...
  std::vector <std::string *> SURL =
    proc? proc->eval_vec_str(srmStatusOfBringOnlineRequest::SURL):
          srmStatusOfBringOnlineRequest::SURL;
